...
import {
  ...
  PopoverContent,
  PopoverTrigger,
} from "@nfl-pool-monorepo/ui/components/popover";
import { ScrollArea } from "@nfl-pool-monorepo/ui/components/scroll-area";
...
>(({ className, ...props }, ref) => (
  <Input
    className={cn("rounded-e-lg rounded-s-none dark:bg-white", className)}
    {...props}
    ref={ref}
  />
));
