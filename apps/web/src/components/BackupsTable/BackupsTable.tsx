								...
								<Table>
									<TableHeader>
										<TableRow className="hidden md:table-row">
											<TableHead className="text-black" scope="col">Restore</TableHead>
											<TableHead className="text-black" scope="col">Name</TableHead>
											<TableHead className="text-black" scope="col">Date</TableHead>
											<TableHead className="text-black" scope="col">AM/PM</TableHead>
										</TableRow>
									</TableHeader>
									<TableBody>
										{results.map(backup => (
												...
												<TableHead className="flex justify-center items-center" scope="row">
													{loading === null && (
														...
														{loading === backup.backupName && (
															<PiFootballDuotone aria-hidden="true" className="animate-spin hidden md:inline-block text-yellow-950" />
														)}
													</TableHead>
