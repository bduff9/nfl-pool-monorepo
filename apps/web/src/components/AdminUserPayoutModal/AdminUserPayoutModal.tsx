...
import { Dialog, DialogClose, DialogContent, DialogDescription, DialogFooter, DialogHeader, DialogTitle } from '@nfl-pool-monorepo/ui/components/dialog';
...
const AdminUserPayoutModal: FC<Props> = ({
	handleClose,
	show = false,
	updateAmount,
	winner,
