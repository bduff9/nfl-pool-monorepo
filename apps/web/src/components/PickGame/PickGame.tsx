      ...
      <div className="w-1/2 md:w-2/3 flex items-center text-center">
        ...
        <div className={cn("cursor-pointer w-2/5 md:w-1/5 flex justify-center")} onClick={onClick}>
          <Image
            ...
            width={60}
          />
          <div className={cn("block md:hidden decoration-dotted underline underline-offset-2")}>{pick.visitorTeam?.TeamName}</div>
        </div>
        {/** biome-ignore lint/a11y/useKeyWithClickEvents: <explanation> */}
        <div
          className={cn("hidden md:block relative cursor-pointer w-2/5 md:w-1/5")}
          onClick={onClick}
        >
          ...
          {isSelected ? (
            <FaTimesCircle
              className="absolute top-1/2 start-0 -translate-y-1/2 text-red-600"
            />
          ) : (
        ...
        <div className={cn("cursor-pointer w-2/5 md:w-1/5 flex justify-center")} onClick={onClick}>
          <Image
            ...
            width={60}
          />
          <div className={cn("block md:hidden decoration-dotted underline underline-offset-2")}>{pick.homeTeam?.TeamName}</div>
        </div>
      </div>
