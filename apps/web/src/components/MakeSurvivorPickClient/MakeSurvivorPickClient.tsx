						...
						<div className="flex flex-wrap">
								{games
									...
									.map(game => (
										<div
											className={cn(
												'w-full md:w-1/2 lg:w-1/3 2xl:w-1/4 flex flex-wrap pb-3 relative h-48',
											)}
										...
										>
											...
											<SurvivorTeam
												...
												pick={optimisticPicks.find(
													pick => pick.TeamID === game.visitorTeam?.TeamID,
												)}
											...
											<SurvivorTeam
												...
												pick={optimisticPicks.find(
													pick => pick.TeamID === game.homeTeam?.TeamID,
												)}
												team={game.homeTeam}
												weekInProgress={weekInProgress}
											/>
